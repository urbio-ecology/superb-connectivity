...
barrier <- read_geometry(here("data/superb-fairy-wren/allSFWRoads.shp")) |> st_as_sf()
habitat <- read_geometry(here("data/superb-fairy-wren/superbHab.shp")) |> clean() |> st_as_sf()
```
