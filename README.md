...
analysis for the superb fairy wren. The code has been lightly adapted
from [urbanConnect](https://github.com/urbio-ecology/urbanConnect), with
the overall method being developed by Holly Kirk et al., in [“Ecological
...
You can see the shiny app in action at:
<https://njtierney.shinyapps.io/urbioconnect/>

## Example usage

You can see example usage of the package, using a targets worfklow at
