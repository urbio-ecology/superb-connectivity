...
* update `effective_mesh_size()` to go from area_squared --> area_baseline and area --> area_new; similarly, `connectivity_probability()` would go from `area` --> `area_baseline()`. #128
